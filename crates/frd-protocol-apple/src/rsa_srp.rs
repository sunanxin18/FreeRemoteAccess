...
use crate::srp::{self, SrpChallenge};
...
fn read_srp_frame_raw(conn: &mut AppleConnection) -> Result<Vec<u8>> {
...
fn read_srp_frame(conn: &mut AppleConnection) -> Result<SrpChallenge> {
