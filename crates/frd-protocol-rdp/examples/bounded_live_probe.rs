    ...
    let graphics_observer: Arc<dyn RdpGraphicsObserver> = Arc::new(
        move |capabilities: RdpGraphicsCapabilities| {
            ...
            *last = Some((summary, Instant::now()));
            ...
            println!("RDP EGFX 阶段 start_calls={} capability_messages_queued={} typed_confirmation_ever={} failure_count={} first_failure={:?} progressive_failure_detail={:?} publisher_failure_detail={:?} publisher_failure_operation={:?} confirmed_version={:x?} confirmed_flags={:x?} unhandled_codec_count={} last_unhandled_codec={:x?}",
                ...
                capabilities.egfx_diagnostics.publisher_failure_detail,
                capabilities.egfx_diagnostics.publisher_failure_operation,
