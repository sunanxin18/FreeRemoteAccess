...
pub enum RdpEgfxFailure {
    ...
    Decoder,
    Publisher,
    PublisherMissingSurface,
    PublisherUnmappedSurface,
    PublisherInvalidRectangle,
    PublisherMissingOutput,
    PublisherOutputBounds,
    PublisherQueueLimit,
    PublisherRevisionOverflow,
    PublisherCodedSizeMismatch,
    UnsupportedCodec,
    Reactivation,
}
