...
2026-09-08 当前进度：macOS 仅支持 ARM64。加入 Linux GL 后端后的 macOS ARM64 完整工作区测试 1720 passed / 0 failed / 16 ignored；默认生产 RDP 仍为 LegacyOnly，显式 `--rdp-egfx-experiment avc420|avc444` 用于采集互操作证据。
