...
- The final offline closure executable is 42,291,712 bytes with SHA-256 `3A679F998E3A7DBD1EF2EAC6D0DAF442A653021A8EB4F6B245D52178144CC345` and PE subsystem 2. This does not replace either sampled Mac binary or upgrade live evidence; the `43db868` artifact above remains merely the prior offline closure build.
