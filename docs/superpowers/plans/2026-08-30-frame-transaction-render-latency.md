...
- The final Release artifact is 42,283,520 bytes with SHA-256 `AFDB76ABA09468C9410B5FAC7E4FB5A46B67D0D928B6275512B207BAC3B2AE69`; that is offline build evidence only. Never substitute it for either sampled hash above, and never use the post-measurement correctness fixes or comparator replay as new live-interoperability evidence.
